"""
Django settings for uyretr_245 project.
...
WSGI_APPLICATION = "uyretr_245.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uyretr_245 API",
    "DESCRIPTION": "API documentation for uyretr_245 App",
    "VERSION": "v1",
}
